import { Box, IconButton, Stack, Typography, Avatar, Divider, Button, Switch, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Slide } from "@mui/material";
...
const DeleteDialog = ({ handleClose, open }) => {
    ...
    return (
        <Dialog
            ...
            aria-describedby="alert-dialog-slide-description"
        >
            <DialogTitle>Delte this chat</DialogTitle>
            <DialogContent>
                <DialogContentText id="alert-dialog-slide-description">
                    Are you sure?
                </DialogContentText>
            ...
            <Stack sx={{ height: "100%" }}>
                ...
                <Stack sx={{ height: "100%", position: "relative", flexGrow: 1, overflowY: "scroll" }} p={3} spacing={3}>
                    ...
                    <Stack spacing={0.5}>
                        ...
                        <Typography variant="body2">God has good plans for you, just have patience</Typography>
                    </Stack>
                    <Divider />
                    ...
                    <Stack direction={"row"} spacing={2} alignItems={"center"}>
                        ...
                        <Stack spacing={0.5}>
                            <Typography variant="subtitle2">Chasing Heights</Typography>
                            <Typography variant="caption">Never ever give up!</Typography>
                        </Stack>
                    </Stack>
                    <Stack direction={"row"} alignItems={"center"} spacing={2}>
                        <Button onClick={() => {
